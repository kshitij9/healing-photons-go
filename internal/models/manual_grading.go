...
type ManualGrading struct {
	ID        string        `json:"id"`
	PeelingID string        `json:"peeling_id"`
	StockID   string        `json:"stock_id"`
	Size180   GradeCategory `json:"size_180"`
	Size210   GradeCategory `json:"size_210"`
	Size240   GradeCategory `json:"size_240"`
	Size280   GradeCategory `json:"size_280"`
	Size320   GradeCategory `json:"size_320"`
	Size400   GradeCategory `json:"size_400"`
